...
def resource_portal_link(resource_id):
    if not resource_id:
        return None
    return f"https://portal.azure.com/#resource{quote(str(resource_id), safe='/')}/overview"
...
def evaluate_findings(catalog, review_overrides=None, baseline_findings=None):
    ...
    surface_findings, surface_sources = evaluate_collection_surface_findings(
        catalog, result, unsupported
    )
    findings.extend(surface_findings)
    reference_sources.update(surface_sources)
