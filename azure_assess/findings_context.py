...
SERVICE_DEFINITIONS = {
    ...
    "pim_": ("entra_pim", "Microsoft Entra Privileged Identity Management", "role assignment or alert"),
    "intune_": ("microsoft_intune", "Microsoft Intune", "managed device or policy"),
    "sharepoint_": ("sharepoint_online", "SharePoint Online", "tenant setting"),
