...
FINDING_ID_OVERRIDES = {
    ...
    "Unhealthy Defender for Identity sensors": "defender_identity_unhealthy_sensors",
    "Unresolved significant Microsoft security incidents": "defender_unresolved_significant_incidents",
    "Applicable Intune estate has no compliance policy": "intune_compliance_policy_missing",
    "Managed encrypted devices lack BitLocker recovery-key metadata coverage": "intune_bitlocker_metadata_coverage_missing",
    ...
    "Permanent eligible privileged directory assignments": "pim_permanent_eligible_directory_assignments",
    "Permanent eligible privileged group assignments": "pim_permanent_eligible_group_assignments",
    "Permanent eligible privileged Azure-resource assignments": "pim_permanent_eligible_azure_resource_assignments",
    "PIM alert configurations are disabled": "pim_alert_configuration_disabled",
    ...
    "Function Apps allow every cross-origin caller": "app_function_cors_wildcard_origin",
    "Batch accounts permit public network access": "batch_public_network_access_enabled",
    "Batch accounts permit local shared-key authentication": "batch_local_shared_key_authentication_enabled",
    "Data Factory instances permit public network access": "data_factory_public_network_access_enabled",
